...
export const numberingWizardSubTitle = [{ text: "Fill up your details and proceed next steps." }];
...
export const shippingFormSubTitle = [{ text: "Fill up your true details and next proceed." }];
