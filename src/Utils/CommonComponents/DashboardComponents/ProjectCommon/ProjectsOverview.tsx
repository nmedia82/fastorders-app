    ...
    <Col xl={6} className={`box-col-6 ${colClass}`}>
      <Card className={`title-line ${cardClass ? cardClass : ""}`}>
        <DropdownWithHeader
          ...
          headerClass="card-no-border"
          heading={ProjectsOverviewTitle}
          headerIconClass="right-xl-dropdown"
          ...
          <div className="project-overview-wrapper">
            <div id="project-overview">
              <ReactApexChart
                ...
                series={projectOverviewOption.series}
                height={height}
              />
            </div>
            <div className="project-back-bar">
              <div id="project-bar">
                <ReactApexChart
                  type="bar"
                  options={projectbarOption}
                  series={projectbarOption.series}
                  height={height2}
                />
              </div>
            </div>
